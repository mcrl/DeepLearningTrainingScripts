...
def main(_):
  ...
  with tf.Graph().as_default():
    ...
    print ("---- num_clones=%d" % FLAGS.num_clones)
    print ("---- clone_on_cpu=%d" % FLAGS.clone_on_cpu)
    print ("---- replica_id=%d" % FLAGS.task)
    print ("---- num_replicas=%d" % FLAGS.worker_replicas)
    print ("---- num_ps_tasks=%d" % FLAGS.num_ps_tasks)
